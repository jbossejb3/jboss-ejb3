...
public abstract class ContainerManagedConcurrencyInterceptor
{
   ...
   public Object invoke(InvocationContext invocationContext) throws Exception
   {
      ...
      TimePeriod defaultAccessTimeout = lockableComponent.getDefaultAccessTimeout();
      // set to the default values
      long time = defaultAccessTimeout.getValue();
      TimeUnit unit = defaultAccessTimeout.getTimeUnit();

      TimePeriod accessTimeoutOnMethod = lockableComponent.getAccessTimeout(invokedMethod);
