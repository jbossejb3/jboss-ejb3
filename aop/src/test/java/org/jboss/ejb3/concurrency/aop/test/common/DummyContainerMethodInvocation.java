 ...
 */
public class DummyContainerMethodInvocation extends ContainerMethodInvocation
   implements EJBInvocation
{
   private EnterpriseBeanEffigy effigy;

   public DummyContainerMethodInvocation(MethodInfo info, BeanContext<?> target, Object[] arguments, SessionBeanEffigy effigy)
   {
      super(info);

      this.effigy = effigy;

      setBeanContext(target);
