...
*/
package org.jboss.ejb3.concurrency.impl.test.unit;
...
public class EJBReadWriteLockTest
{
   ...
   /**
    * Test that a {@link IllegalLoopbackException} is thrown when the thread owning a read lock
    ...
    * of time. After processing, it will unlock the {@link Lock} 
    * 
    *
    * @author Jaikiran Pai
    * @version $Revision: $
