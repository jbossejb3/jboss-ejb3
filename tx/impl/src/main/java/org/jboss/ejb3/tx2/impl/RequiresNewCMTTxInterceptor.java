...
/**
 * Interceptor for container managed transactions of type {@link javax.ejb.TransactionAttributeType#REQUIRES_NEW}
 *  
 * Author : Jaikiran Pai
 */
public class RequiresNewCMTTxInterceptor extends CMTTxInterceptor
{
   /**
    * Handles a {@link javax.ejb.TransactionAttributeType#REQUIRES_NEW} invocation
    *
